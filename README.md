# Backhaul Installer ![GitHub Downloads](https://img.shields.io/github/downloads/amirmbn/Backhaul-Installer/total)
<br>
...
```
bash <(curl -Ls https://raw.githubusercontent.com/amirmbn/Backhaul-Tunnel/main/install.sh)
```
</div>
<div align="right">
<br>
